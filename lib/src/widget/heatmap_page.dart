...
class HeatMapPage extends StatelessWidget {
  ...
  HeatMapPage({
    ...
    this.margin,
    this.showText,
    required this.staticWeekdayLabels,
  ...
  Widget _scrollableWeekDayLabels() {
    return staticWeekdayLabels
